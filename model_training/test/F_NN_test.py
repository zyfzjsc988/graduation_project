...
train_f,test_f = feature[0:train_size],feature[train_size-look_back:len(feature)]
# reshape
...
# model = Sequential()
# model.add(LSTM(30,input_dim=40,activation='tanh'))
...
model = Sequential()
model.add(Dense(30,input_dim=40,activation='relu'))
...
# 保存history文件
json_file = open(output_path + '/history_' + '0116_FBP_NO' + '.json', 'w', encoding='utf-8')
